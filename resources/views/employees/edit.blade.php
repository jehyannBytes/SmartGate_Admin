      ...
      <div>
        <label class="flex items-center gap-3 cursor-pointer">
          ...
          <input type="checkbox" name="is_active" value="1"
                 ...
                 class="w-4 h-4 accent-[#1e2a5e]"/>
          <span class="text-slate-700 text-sm">Active Employee</span>
        </label>
      </div>
        ...
        <div class="flex items-center gap-4">
          <div id="photo-preview-wrap"
            ...
            @if($employee->photo_url)
              ...
              <svg id="photo-placeholder" class="w-8 h-8 text-slate-300 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
          ...
          <div class="flex-1">
            ...
            <p class="text-slate-400 text-xs mt-1.5">JPG or PNG, max 5MB. Leave blank to keep current photo.</p>
